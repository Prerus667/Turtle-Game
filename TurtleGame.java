...
public class TurtleGame extends JPanel {
	 ...
	 * and start the first game.  This constructor just calls {@link #TurtleGame(int)}
	 ...
	 */
	public TurtleGame(int mineCount) {
	 ...
	 *   should be "reasonable"; see the comments on the construtor {@link #TurtleGame(int)}.
	 */
